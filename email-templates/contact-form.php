...
$message = '<html>
			...
			<body>
				...
				<tr>
				<td colspan="2" align="center" valign="top"><img style="margin-top: 15px;" src="https://propertymonk.com.au/images/logo.png" ></td>
				</tr>
				<tr>
...
$mail->SMTPSecure = false;
    ...
    // Recipients
    $mail->setFrom('info@redlionadv.com', 'Red Lion Advisory');
    $mail->addAddress('simit.shah@redlionadv.com'); // 👈 Email goes here
	$mail->addAddress('idris.elgabalawy@redlionadv.com');
    $mail->addAddress('info@redlionadv.com');
...
$mail->SMTPSecure = false;
    ...
    // Recipients
    $mail->setFrom('info@propertymonk.com.au', 'Property Monk');
    //$mail->addAddress('dhavalb@propertymonk.com.au'); // 👈 Email goes here
    $mail->addAddress('contact@propertymonk.com.au');

    // $mail->addReplyTo('kishan1481990@gmail.com', 'Kishan Patel'); // Optional

    // Content
    $mail->isHTML(true);
    $mail->Subject = 'Contact Form Submission';
    $mail->Body    = 'Testing SMTP mail from Property Monk.';
